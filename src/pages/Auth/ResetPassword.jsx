...
export default function ResetPassword() {
  ...
  const userEmail = JSON.parse(Cookies.get("userInfo")).email;
  ...
  const [resetPasswordApi, { isError, isLoading, isSuccess }] =
      ...
      <div className="z-10 w-full max-w-md">
        <div className="mb-2 text-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="text-left">
              <input
                ...
                className="w-full cursor-not-allowed rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-600 transition-colors"
              />
              {errors.email && (
                <span className="mt-1 block text-sm text-red-500">
          ...
          <div className="mt-2">
            ...
            >
              <span className="cursor-pointer font-medium">Back to login</span>
            </button>
          </div>
        </div>
      </div>
